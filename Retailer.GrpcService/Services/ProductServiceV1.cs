...
{
    public class ProductServiceV1 : Product.V1.Product.ProductBase
    {
        private readonly IProductManager _productManager;
        private readonly IMapper _mapper;
        private readonly int? tempInt = 15;

        public ProductServiceV1(IProductManager productManager, IMapper mapper)
        {
        ...
        public override async Task<ProductModelList> GetProductsByIds(IAsyncStreamReader<GetProductByIdRequest> requestStream, ServerCallContext context)
        {
        ...
        public override async Task GetStreamProductsByIds(IAsyncStreamReader<GetProductByIdRequest> requestStream, IServerStreamWriter<ProductModel> responseStream, ServerCallContext context)
        {
        ...
        public override async Task BiDirectionalExampleMethod(IAsyncStreamReader<BiDirectionalRequest> requestStream, IServerStreamWriter<BiDirectionalResponse> responseStream, ServerCallContext context)
        {
